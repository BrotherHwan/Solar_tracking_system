...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","KWS_LIN","PASSWD"}, \
				{0,-1,"","KWS_BT","PASSWD"},  {0,-1,"","KWS_WIFI","PASSWD"}, \
				{0,-1,"","KWS_AND","PASSWD"},  {0,-1,"","KWS_SQL","PASSWD"}, \
				{0,-1,"","ESS_LIN","PASSWD"},  {0,-1,"","ESS_BT","PASSWD"}, \
				{0,-1,"","ESS_WIFI","PASSWD"},  {0,-1,"","ESS_SQL","PASSWD"}, \
				{0,-1,"","ESS_AND","PASSWD"},  {0,-1,"","11","PASSWD"}, \
